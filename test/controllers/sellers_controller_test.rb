...
class SellersControllerTest < ActionController::TestCase
  ...
  test "should create seller" do
    assert_difference('Seller.count') do
      post :create, seller: { documentbuyer: @seller.documentbuyer, documentseller: @seller.documentseller, inscription: @seller.inscription, lastnamebuyer: @seller.lastnamebuyer, lastnameseller: @seller.lastnameseller, namebuyer: @seller.namebuyer, nameseller: @seller.nameseller, user_id: @seller.user_id, yearinscription: @seller.yearinscription }
    end
